...
using LinkShorteningService.IdentityServer.DataAccess.Constants;
using LinkShorteningService.IdentityServer.DataAccess.Data.Identity;
using LinkShorteningService.IdentityServer.Web.Attributes;
using LinkShorteningService.IdentityServer.Web.Extensions;
using LinkShorteningService.IdentityServer.Web.Models;
...
namespace LinkShorteningService.IdentityServer.Web.Controllers
{
	[SecurityHeaders]
	[AllowAnonymous]
